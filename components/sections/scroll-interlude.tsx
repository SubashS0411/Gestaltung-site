 ...
 * CSS-only atmospheric visuals with parallax gradient background.
 */
            ...
            <motion.div style={{ y: textY, opacity }} className="relative z-10 text-center px-6 max-w-3xl">
                {topText && (
                    <motion.p
                        ...
                        className="font-mono text-[11px] text-gold tracking-[0.5em] uppercase mb-6"
                    >
                        {topText}
                    </motion.p>
                )}
                <div className="overflow-hidden">
                    <motion.h2
                        ...
                        className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-white tracking-[0.06em] leading-[1.1]"
                    >
                        {headline}
                    </motion.h2>
                </div>
                {subtext && (
                    <motion.p
                        ...
                        className="font-mono text-sm text-white/50 tracking-wider mt-6 leading-relaxed max-w-lg mx-auto"
                    >
                        {subtext}
                    </motion.p>
                )}
